    ...
    <nav class="navbar navbar-expand-md navbar-light bg-light fixed-top shadow">
            ...
            <div class="collapse navbar-collapse" id="collapsibleNavbar">
                <ul class="navbar-nav ms-auto me-5">
                    <li class="nav-item">
                        <a href="index.php" class="nav-link activate text-white">Service List</a>
                    </li>
                    <li class="nav-item">
                        ...
                        <table id="table" class="table table-hover table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th class="p-3">Edit Service</th>
                                    <th class="p-3">Delete Service</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php
                                ...
                                foreach($data as $details) {
                                    echo "
                                        <tr>
                                            ...
                                            <td class='p-3'>
                                                <form action='styles/php/carts.php' method='post'>
                                                    <input type='hidden' name='service' id='".$details['name']."' value='".$details['name']."'>
                                                    <input type='hidden' name='price' id='".$details['name']."' value='".$details['price']."'>
                                                    <input type='submit' class='btn btn-outline-primary' value='Add To Cart'>
                                                </form>
                                            </td>
                                            <td class='p-3'>
                                                <a href='services.php?id=".$details['id']."'><button class='btn btn-outline-info'>Edit Service</button></a>
                                            </td>
                                            <td class='p-3'>
                                                <a href='delete.php?id=".$details['id']."'><button class='btn btn-outline-danger'>Delete Services</button></a>
                                            </td>
                                        </tr>
                                    ";
                                }
